...
row_details <- function(index) {
  ...
  urls <-
    unlist(strsplit(gsub(",", " , ", data$Links, perl = TRUE), "[ \n]"))
  evidence <-
    unlist(strsplit(gsub(",", " , ", data$Evidence_link, perl = TRUE), "[ \n]"))
  ...
  detail <-  htmltools::div(
    ...
    pkg_field(
      "For a selection of experimental evidence click here",
      lapply(evidence, function(url) {
        if (grepl("https?://", url))
          tags$a(href = url, url)
        else if (identical(url, ","))
          ", "
